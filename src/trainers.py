...
class ICLRecTrainer(Trainer):
    ...
    def iteration(self, epoch, dataloader, cluster_dataloader=None, full_sort=True, train=True):
        ...
        if train:
            ...
            if self.args.contrast_type in ["IntentCL", "Hybrid"] and epoch >= self.args.warm_up_epoches:   ####self.args.warm_up_epoches=0
        ...
        else:  # test 测试阶段，算预测分数
            #dataloader is test_dataloader/valid_dataloader
